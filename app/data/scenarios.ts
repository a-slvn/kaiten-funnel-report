...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    expectedResult: [
      ...
      'Показан только alert "NO_AMOUNT_FIELD" со ссылкой на статью о настройке суммы.',
    ],
  ...
  },
  {
    ...
    action: 'Открыть отчёт и проверить, что график сразу строится по сумме.',
    expectedResult: [
      'В шапке графика нет кнопок переключения метрики.',
  ...
  },
  {
    ...
    action: 'Открыть отчёт и проверить баннеры и переключатель метрик.',
    expectedResult: [
  ...
  },
  {
    ...
    action: 'Открыть отчёт и проверить предупреждение про частично заполненную конфигурацию.',
    expectedResult: [
